...
/**
 * GET /data?job_id=xxx
 * Returns the original uploaded data for a job
 */
exports.getData = (req, res) => {
  try {
    ...
    console.log(`📊 Returning ${job.data?.length || 0} rows of data for job ${jobId}`);
    return res.json({ job_id: jobId, data: job.data || [] });
  } catch (err) {
